...
- Let the existing narrator repair persist canonical `af_heart` config and invalidate the rejected render.
...
- Iterate if any major visual/narration issue remains.
